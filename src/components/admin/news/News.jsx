    ...
    items_HTMLTABLE = (
      <>
        <div className="mx-0 grid grid-cols-12 text-center break-all">
          ...
          <div className="pb-3 col-span-5 md:col-span-2 text-start">Title</div>
          <div className="pb-3 col-span-5 md:col-span-6 text-start">Content</div>
          ...
          {itemsList.map((item) => {
            return (
              <div key={item.id} className="mx-0 grid grid-cols-12 text-center break-all">
                ...
                <div className="pt-3 col-span-5 md:col-span-2 text-start">{item.title}</div>
                <div className="pt-3 col-span-5 md:col-span-6 text-start">{item.content}</div>
      ...
      <div className="max-w-[80rem] p-5 mx-auto">
        <div className="rounded-lg shadow-lg">
          <div className="flex justify-between items-center bg-gray-100 p-3 rounded-t-lg">
            <h5 className="mb-3 mb-0">News ( {itemsList.length} )</h5>
            <button
              type="button"
