...
export default function EditSubCategory({ show, hide, subCategory, afterLeave }) {
  ...
  async function handleSubmit(e) {
    ...
    setSending(true);
    try {
      const res = await axios.put("/sub-categories/updateById", data);
  ...
  return (
    ...
    >
      <div className="flex justify-between bg-gray-50 pb-5 px-2">
        <h3 className="text-lg font-medium text-gray-900">Modifier sous-catégorie</h3>
        <button
          type="button"
          onClick={() => {
            hide();
