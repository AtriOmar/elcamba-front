    ...
    items_HTMLTABLE = (
      <>
        <div className="mx-0 grid grid-cols-12 break-all text-center">
          ...
          <div className="col-span-5 pb-3 text-start md:col-span-2">Category</div>
          <div className="col-span-5 pb-3 text-start md:col-span-6">Name</div>
          <div className="col-span-2 pb-3 text-end sm:text-center md:col-span-3">Actions</div>
        </div>
        <div className="divide-y">
          {itemsList.map((item) => {
            return (
              <div key={item.id} className="mx-0 grid grid-cols-12 break-all text-center">
                <div className="col-span-1 hidden pt-3 text-start md:block">{item.id}</div>
                <div className="col-span-5 pt-3 text-start md:col-span-2">{item.SubCategory?.name}</div>
                <div className="col-span-5 pt-3 text-start md:col-span-6">{item.name}</div>
                <div className="col-span-2 pt-3 text-end sm:text-center md:col-span-3">
      ...
      <div className="mx-auto max-w-[80rem] p-5">
        <div className="rounded-lg shadow-lg">
          <div className="flex items-center justify-between rounded-t-lg bg-gray-100 p-3">
            <h5 className="mb-0 mb-3">Products ( {itemsList.length} )</h5>
            <button
              type="button"
